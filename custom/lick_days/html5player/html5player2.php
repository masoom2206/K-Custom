<?php
	require '/opt/web/admin/public_html/sites/all/modules/custom/gmc_chats/chat-calender-list/lib/classes/App.php';
	...
	//$lesson_url = 'C-Lydian-Lick.mp4';
	$lesson_url = 'http:\/\/www.guitarmasterclass.net\/actions\/getlessonpartslist\/3353\/?jsonp=App.lesson_data';
    if( isset($_GET['lotd']) ) {
...
<html>
  <head>
	...
	<script type="text/javascript">App.lesson_data = {"parts":[["\/sites\/default\/files\/lick_of_the_day\/mp4\/C%20Lydian%20Lick.mp4","\/sites\/default\/files\/lick_of_the_day\/mp4\/C%20Lydian%20Lick.mp4","\/sites\/default\/files\/lick_of_the_day\/mp4\/C%20Lydian%20Lick.mp4?mobile=1"]],"backingtracks":[{"title":"160","id":35380,"length":"60","url":"\/sites\/default\/files\/lick_of_the_day\/mp4\/C%20Lydian%20Lick.mp3","downloadable":true},],"free_tacks":"\/icp\/lm2\/files\/uploads\/133\/35380.mp3","coverlesson":0,"coverd_lesson":false,"tools":{"Tabs":["\/actions\/getlessontool\/tabs\/3353\/","\/test\/icons\/tabs.jpg"],"GuitarPro":["\/actions\/getlessontool\/gp5\/3353\/","\/test\/icons\/gp.jpg"],"PDF":["\/actions\/getlessontool\/file\/3353\/","\/img\/pdf.jpg"]}};</script>
  </head>
...
<div id="player_box">
	...
	<div id="player">
	    <div>
			<video preload="metadata" id="mp4_player">
			<!--<source type="video/mp4" src="http://admin.prod.gmc.my/sites/default/files/lick_of_the_day/mp4/C%20Lydian%20Lick.mp4">-->
			<source type="video/mp4" src="C-Lydian-Lick.mp4">
			</video>
	    </div>
	</div>
...
<script type="text/javascript" src="/sites/all/modules/custom/lick_days/html5player/html5player.js"></script>
<script type="text/javascript" src="/sites/all/modules/custom/lick_days/html5player/html5player2.js"></script>
<script type="text/javascript" src="/sites/all/modules/custom/lick_days/html5player/jquery.mobile.custom.js"></script>-->
