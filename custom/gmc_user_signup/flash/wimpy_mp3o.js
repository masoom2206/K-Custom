...
/////////////////////////////////////////////////////////////
//
// Refer to the "wimpyJS_readme.html" file for details.
//
//wimpySwf = "/flash/wimpy_mp3.swf";
wimpySwf = "/sites/all/modules/custom/gmc_user_signup/flash/wimpy_mp3v3.swf";
theWidth = 200;
theHeight = 15;
theBkgdColor = "F9EFBA";
wimpyConfigFile = "";
wimpySkin = "/sites/all/modules/custom/gmc_user_signup/flash/skin_simple_bar.xml";
trackPlays = "";
voteScript = "";
...
function makeWimpyPlayer(thePlaylist){
	...
	var myConfigs = "wimpySkin,trackPlays,voteScript,defaultImage,startPlayingOnload,shuffleOnLoad,randomOnLoad,displayDownloadButton,startOnTrack,autoAdvance,popUpHelp,scrollInfoDisplay,infoDisplayTime,bufferAudio,theVolume,js_wimpy_returnOnComplete,limitPlaytime";
	...
	//
	queryString = wimpySwf +'?wimpyReg=NyUzQVpseUwlMjRfJTdEJTgwUGJiUWxlJTQwJTI5WSU4NTFMcVklN0NXWUtDQjQlM0Itd3BLS3MlM0I4&x='+randNum+altString+writePlaylist;
	//
